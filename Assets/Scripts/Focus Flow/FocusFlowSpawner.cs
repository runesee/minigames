...
public class FocusFlowDataSpawner : NetworkBehaviour
{
    ...
    private IEnumerator SpawnPlayers()
    {
        ...
        while (NetworkManager.Singleton.ConnectedClientsList.Count < MinigameManager.PLAYER_COUNT || FocusFlowGameState.Instance == null) yield return new WaitForSeconds(0.1f);
